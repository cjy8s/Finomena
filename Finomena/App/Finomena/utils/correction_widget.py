...
class CorrectionWidget(QWidget):
    ...
    def __init__(self, parent=None):
        ...
        self._variable_names: list[str] = ["var0", "var1"]
    ...
    def set_variable_names(self, names: list):
        ...
        # Simpler → more complex hypothesis order. Rebuilding here guarantees
        # the default reflects the current design variables.
    ...
    def get_spec(self) -> dict:
        ...
        if self._flat_radio.isChecked():
            return {
                ...
                # question (one <var>_Effect family per design variable, plus
                # Full_Interaction).
                "scope":        "per_family",
            }
        # Tree
    ...
    def _build_ui(self):
        ...
        self._reset_btn = QPushButton("Reset to default tree")
        ...
        # individual contrasts (a literal rendering of every phase × every
        # condition combination would be unreadable).
        preview = QWidget()
        ...
        # Seed with default tree + render preview
        self._populate_default_tree()
        self._update_status()
        self._render_preview()
    ...
    def _populate_default_tree(self):
        ...
        if len(self._variable_names) >= 2:
            ...
            # Default tree, simpler → more complex hypothesis:
            #   L1 = gate        ({var0}_Effect, all contexts)
            #   L2 = effect      ({var1}_Effect, gated on var0)
            #   L3 = specificity (Full_Interaction, gated on var1)
            defaults = [
                {
                ...
                },
                {
                    ...
                    "linkage_key": gate_var,
                },
                {
                    "name":        f"L3 Interaction specificity",
                    "Test_Family": "Full_Interaction",
                    "linkage_key": screen_var,
                },
            ]
        else:
            defaults = []
